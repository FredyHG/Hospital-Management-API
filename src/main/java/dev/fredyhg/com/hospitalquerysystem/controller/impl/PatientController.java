...
public class PatientController {
    ...
    public List<Patient> findByFirstNameAndLastName(@PathVariable String firstName, @PathVariable String lastName) {
    ...
    public ResponseEntity<Object> save(@RequestBody @Valid PatientPostRequestBody patient){
        ...
        Optional<Patient> patientToBeConvert = patientService.findByCPF(patient.getCpf());
    ...
    public ResponseEntity<Object> deleteByCpf(@PathVariable String cpf){
        ...
        Optional<Patient> patientExist = patientService.findByCPF(cpf);
